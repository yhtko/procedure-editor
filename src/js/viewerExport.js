(function (ns) {
  ...
  function viewerCss() {
    return [
      ...
      ".annotation{position:absolute;min-width:14px;min-height:14px;color:#ef4444;line-height:1}.annotation-circle,.annotation-number{min-width:0;min-height:0;height:auto;aspect-ratio:1/1;border-radius:50%}.annotation-circle{border:3px solid currentColor;background:transparent}.annotation-marker{border:3px solid #2563eb;background:rgba(37,99,235,.14);border-radius:0}.annotation-number{display:flex;align-items:center;justify-content:center;border:2px solid #fff;background:currentColor;box-shadow:0 1px 7px rgba(15,23,42,.32)}.annotation-number span{color:#fff;font-weight:700;font-size:clamp(12px,2.6vw,30px);line-height:1}.annotation-arrow{overflow:visible}.annotation-arrow svg{display:block;width:100%;height:100%;overflow:visible}.annotation-arrow line{stroke-width:2.2;stroke-linecap:round;vector-effect:non-scaling-stroke}",
